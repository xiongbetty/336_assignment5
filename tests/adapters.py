...
from cs336_alignment.baseline_results.mmlu_baseline import parse_mmlu_response
from cs336_alignment.baseline_results.gsm8k_baseline import parse_gsm8k_response
...
def get_packed_sft_dataset(
    ...
    """
    return InstructionTuning(tokenizer=tokenizer, dataset_path=dataset_path, seq_length=seq_length, shuffle=shuffle)
